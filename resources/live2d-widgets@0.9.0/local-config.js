// Live2D 本地配置文件
// 可以在这里修改模型和对话配置
// 配置会自动设置到 window 对象供 autoload.js 使用

window.localModelConfig = {
  models: [
    "Majonotabi/Inena",
    "Hokai/kafuka"
  ],
...
window.localWaifuConfig = {
  "mouseover": [{
    ...
    "text": ["要不要来玩飞机大战？", "这个按钮上写着「不要点击」。", "想来和我一起玩个游戏吗？", "听说这样可以蹦迪！"]
  }, {
    "selector": "#waifu-tool-switch-model",
    "text": ["你是不是不爱人家了呀，呜呜呜～", "要见见我的姐姐嘛？", "想要看看我妹妹嘛？", "要切换看板娘吗？"]
  }, {
